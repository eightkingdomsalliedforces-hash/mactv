...
struct TVShellChecks {
    ...
    static func checkOfficialAnimeSourceStateAndAniGamerCatalog() throws {
        ...
        try expect(AniGamerOfficialPageScript.source.contains("年齡") && AniGamerOfficialPageScript.source.contains("click()"), "aniGamer acknowledges a visible age prompt as a normal click")
